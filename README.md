...
**A.U.R.A. (Autonomous & Unified Residential Administrator)** — a goal-oriented smart home app built with **Flutter** (web & desktop) and **Serverpod** for backend integration.
